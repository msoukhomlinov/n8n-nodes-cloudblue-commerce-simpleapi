...
export class OrderResource extends BaseResource {
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                ...
                default: '',
                description:
                  'Filter orders created before this date and time (ISO-8601 UTC format)',
              },
              {
                displayName: 'Offset',
                name: 'offset',
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                ...
                options: [
                  {
                    name: 'Count Migration Billing Period',
                    value: 'count_migration_billing_period',
                  },
                  {
                    name: 'Do Not Count Migration Billing Period',
                    value: 'do_not_count_migration_billing_period',
                  },
                  {
                    name: 'Prorate Migration Billing Period',
                    value: 'prorate_migration_billing_period',
                  },
                ],
                default: '',
  ...
  async execute(
    ...
    switch (operation) {
      case 'list': {
        ...
        if (returnAll) {
          const orders = await this.paginationService.getPaginatedResults<IOrder>(
            this.apiService,
            executeFunctions,
            this.basePath,
            {
        ...
        qs.limit = limit;
        return this.makeRequest<IOrder>(executeFunctions, 'GET', '', undefined, qs);
      }

      case 'get': {
        const id = executeFunctions.getNodeParameter('id', i) as string;
        return this.makeRequest<IOrder>(executeFunctions, 'GET', `/${id}`);
      }
      ...
      case 'create': {
        ...
        return this.makeRequest<IOrder>(executeFunctions, 'POST', '', body);
      }
      ...
      case 'estimate': {
        ...
        return this.makeRequest<unknown>(executeFunctions, 'POST', '/estimate', body);
      }
      ...
      case 'update': {
        ...
        return this.makeRequest<IOrder>(executeFunctions, 'PATCH', `/${id}`, {
          creditCheck,
        });
      }
  ...
  async loadOptions(
    ...
    if (propertyName === 'orderId') {
      const response = await this.makeRequest<IOrder>(loadOptionsFunctions, 'GET', '', undefined, {
        limit: 100,
      });
