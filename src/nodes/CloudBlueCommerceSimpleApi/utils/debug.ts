 ...
 * @description Provides debugging and logging functionality for the CloudBlue Commerce SimpleAPI integration.
 * Features include:
 ...
 *
 * @module CloudBlueCommerceSimpleApi/utils/debug
 */
