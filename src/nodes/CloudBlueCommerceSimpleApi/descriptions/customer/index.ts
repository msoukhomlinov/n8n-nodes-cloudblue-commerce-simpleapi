/**
 * @file Customer Resource Descriptions
 * @description Defines the operations and fields available for the Customer resource.
 *
 * Contains:
 * - Operation definitions (create, get, getMany, update)
 * - Field descriptions and validation rules
 * - Display options and conditional rendering
 * - Input validation requirements
 * - Complex field structures (contact, address)
 *
 * @module CloudBlueCommerceSimpleApi/descriptions/customer
 */
...
export const customerFields: INodeProperties[] = baseCustomerFields;
